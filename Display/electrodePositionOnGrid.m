...
if strcmpi(gridType,'Microelectrode')
    ...
    elseif strcmp(subjectName,'alpa') || strcmp(subjectName,'kesari') || strcmp(subjectName,'test') || isempty(subjectName)
    ...
    elseif strcmp(subjectName,'tutu') || strcmp(subjectName,'alpaH')
