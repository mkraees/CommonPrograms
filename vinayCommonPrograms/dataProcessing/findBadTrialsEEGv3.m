...
% 07 July 2017, modified as per findBadTrialsWithLFPv3
%==========================================================================


function [allBadTrials, badTrials, nameElec] = findBadTrialsEEGv3(subjectName,expDate,protocolName,folderSourceString,gridType,...
...
summaryFig = figure('name',[subjectName expDate protocolName],'numbertitle','off');
...
saveas(summaryFig,fullfile(folderSegment,[subjectName expDate protocolName 'summmaryBadTrials.fig']),'fig');
saveas(summaryFig,[subjectName expDate protocolName 'summmaryBadTrials.fig'],'fig');
